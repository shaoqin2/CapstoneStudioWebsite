...
class Homework(models.Model):
    ...
    assigned_by = models.ForeignKey(Teacher, on_delete=models.CASCADE, related_name="related_homework",
                                    verbose_name='布置老师')
    belong_to_class = models.ForeignKey(Class, on_delete=models.CASCADE, related_name="related_homework",
                                        verbose_name='所属课程')
    ...
    submissionChoice = (("Submit by Email", "Submit by Email"), ("Submit in Person", "Submit in Person"),
                        ("Submit by Wechat", "Submit by Wechat"), ("Submit in Class", "Submit in Class"),
                        ("No need to Submit", "No need to Submit"))
